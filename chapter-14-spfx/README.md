...
full chapter 14 syllabus of *La Experiencia SharePoint*. Each project is an
...
| # | Folder | Type | Chapter 14 section covered | Build |
|---|---|---|---|---|
| 01 | `01-webpart-hello-graph` | Web Part (React) | MSGraphClientV3 + hooks + Property Pane | ✅ green (0 warnings) |
| 02 | `02-field-customizer-priority` | Field Customizer | Types of Extensions | ✅ green (0 warnings) |
| 03 | `03-command-set-actions` | Command Set | Types of Extensions | ✅ green (0 warnings) |
| 04 | `04-application-customizer-footer` | Application Customizer | Types of Extensions | ✅ green (0 warnings) |
| 05 | `05-ace-viva-card` | Adaptive Card Extension | ACE in detail | ✅ green (0 warnings) |
| 06 | `06-webpart-documents-explorer` | Web Part (React) | Graph Access Pattern | ✅ green (0 warnings) |
| 07 | `07-webpart-permissions-panel` | Web Part (React) | Graph + permissions (capstone) | ✅ green (0 warnings) |
...
| 10 | `10-webpart-no-framework` | Web Part (no React) | Web Part without React | ✅ green (0 warnings) |
| 11 | `11-teams-enabled-webpart` | Web Part + Teams | Integration with Teams | ✅ green (0 warnings) |
| 12 | `12-cicd-workflow` | GitHub Actions | CI/CD for SPFx | ✅ created (no build) |
...
→ API Access**. Scope policy follows the book's "least privilege" rule
...
the chapter 14 "Testing SPFx" section (the others replicate it):
